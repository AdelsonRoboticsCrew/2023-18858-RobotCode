...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.04007; // output (wheel) speed / input (motor) speed
     ...
     */
    public static double MAX_VEL = 47.7022;
    public static double MAX_ACCEL = 49.4828;
    public static double MAX_ANG_VEL = 3.1;
